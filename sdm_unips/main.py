...
parser.add_argument('--checkpoint', default='/home/user/dataset/ckpt/sdm_unips/')
...
parser.add_argument('--test_dir', default='/home/user/dataset/DiLiGenT_518')
parser.add_argument('--test_prefix', default='[0-9]*')
...
def main():
    ...
    import os
    objname = os.path.basename(test_data.objlist[0]) if len(test_data.objlist) > 0 else ""
    print(f"        python sdm_unips/relighting.py --datadir ./{args.session_name}/results/{objname}\n")
